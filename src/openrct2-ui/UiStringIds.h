...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_USE_ASTAR_PATHFINDING = 7031,
        STR_USE_ASTAR_PATHFINDING_TIP = 7032,
        STR_SPREAD_GUESTS_ON_WIDE_PATHS = 7033,
        STR_SPREAD_GUESTS_ON_WIDE_PATHS_TIP = 7034,
