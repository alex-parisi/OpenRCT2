...
/** rct2: 0x008A92E8 (Flat) — see paint/track_pieces/Flat.h::trackPaintFlatInverted */
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRcFlatChainSprites = { 27131, 27132, 27131, 27132 };
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRcFlatSprites = { 27129, 27130, 27129, 27130 };
...
/** rct2: 0x008A92F8 (25DegUp) — see paint/track_pieces/Flat.h::trackPaint25DegUpInverted */
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRc25DegUpChainSprites = { 27249, 27250, 27251,
                                                                                                     27252 };
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRc25DegUpSprites = { 27221, 27222, 27223, 27224 };
...
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRcFlatTo25DegUpChainSprites = { 27241, 27242, 27243,
                                                                                                           27244 };
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRcFlatTo25DegUpSprites = { 27213, 27214, 27215,
                                                                                                      27216 };
...
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRc25DegUpToFlatChainSprites = { 27245, 27246, 27247,
                                                                                                           27248 };
static constexpr std::array<ImageIndex, kNumOrthogonalDirections> kInvertedRc25DegUpToFlatSprites = { 27217, 27218, 27219,
                                                                                                      27220 };
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    OpenRCT2::trackPaint25DegUpInverted<
        kInvertedRc25DegUpChainSprites, kInvertedRc25DegUpSprites, 29, 45, 62, 72, kTunnelGroup>(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    OpenRCT2::trackPaint25DegUpToFlatInverted<
        kInvertedRc25DegUpToFlatChainSprites, kInvertedRc25DegUpToFlatSprites, 29, 37, 52, 56, kTunnelGroup>(
        session, ride, trackSequence, (direction + 2) & 3, height, trackElement, supportType);
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    OpenRCT2::trackPaintFlatTo25DegUpInverted<
        kInvertedRcFlatTo25DegUpChainSprites, kInvertedRcFlatTo25DegUpSprites, 29, 37, 54, 64, kTunnelGroup>(
        session, ride, trackSequence, (direction + 2) & 3, height, trackElement, supportType);
}
    ...
    switch (trackType)
    {
        case TrackElemType::flat:
            return OpenRCT2::trackPaintFlatInverted<
                kInvertedRcFlatChainSprites, kInvertedRcFlatSprites, 29, 29, 3, kSupportHeight, 48, kTunnelGroup>;
